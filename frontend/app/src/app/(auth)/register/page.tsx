    ...
    <div className="flex items-center justify-center min-h-screen px-6">
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <label className="block text-accent/60 text-xs uppercase tracking-widest mb-2 ml-1">Username</label>
            <input
              type="text"
              required
              className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:border-accent/40 outline-none transition-all font-serif"
        ...
        <p className="mt-8 text-center text-foreground/40 text-sm">
          Already a traveler? <Link href="/login" className="text-accent/60 hover:text-accent tracking-widest">Sign In</Link>
        </p>
      </motion.div>
    </div>
  );
